...
type PlaylistTableFiltersProps = {
  querySearch: string
...
export default function PlaylistTableFilters({
  querySearch,
  setQuerySearch,
  selectedStates,
  setSelectedStates,
  ...
  const buildParams = React.useCallback(
    ...
    [querySearch, selectedStates, selectedOwnerIds, dateFrom, dateTo, limit]
  )
