...
export function PlaylistDataTableRowActions({ row }: DataTableRowActionsProps<Data.Playlist>) {
  return (
    <Menu>
      <MenuTrigger
        render={
      ...
      <MenuPopup align="end" className="w-40">
        <MenuItem
          render={<Link route="admin.playlists.edit" routeParams={{ id: row.original.id }} />}
        >
          Edit
        </MenuItem>
        ...
        <Can I="delete" a="playlist">
          <MenuItem
            ...
            render={<Link route="admin.playlists.destroy" routeParams={{ id: row.original.id }} />}
          >
            Delete
            <MenuShortcut>
              <TrashIcon size={16} />
