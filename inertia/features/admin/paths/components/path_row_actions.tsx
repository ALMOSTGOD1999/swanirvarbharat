...
export function PathDataTableRowActions({ row }: DataTableRowActionsProps<Data.Path>) {
  return (
    <Menu>
      <MenuTrigger
        render={
      ...
      <MenuPopup align="end" className="w-40">
        <MenuItem render={<Link route="admin.paths.edit" routeParams={{ id: row.original.id }} />}>
          Edit
        </MenuItem>
        ...
        <Can I="delete" a="path">
          <MenuItem
            ...
            render={<Link route="admin.paths.destroy" routeParams={{ id: row.original.id }} />}
          >
            Delete
            <MenuShortcut>
              <TrashIcon size={16} />
