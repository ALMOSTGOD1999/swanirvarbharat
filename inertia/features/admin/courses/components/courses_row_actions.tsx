...
export function CoursesDataTableRowActions({ row }: DataTableRowActionsProps<Data.Course>) {
  return (
    <Menu>
      <MenuTrigger
        render={
      ...
      <MenuPopup align="end" className="w-40">
        <MenuItem
          render={<Link route="admin.courses.edit" routeParams={{ id: row.original.id }} />}
        >
          Edit
        </MenuItem>
        ...
        <Can I="delete" a="course">
          <MenuItem
            ...
            render={<Link route="admin.courses.destroy" routeParams={{ id: row.original.id }} />}
          >
            Delete
            <MenuShortcut>
              <TrashIcon size={16} />
