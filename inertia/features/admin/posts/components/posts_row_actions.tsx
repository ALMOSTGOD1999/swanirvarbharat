...
export function PostsDataTableRowActions({ row }: DataTableRowActionsProps<Data.Post>) {
  return (
    <Menu>
      <MenuTrigger
        render={
      ...
      <MenuPopup align="end" className="w-40">
        <MenuItem render={<Link route="admin.posts.edit" routeParams={{ id: row.original.id }} />}>
          Edit
        </MenuItem>
        ...
        <Can I="delete" a="Post">
          <MenuItem
            ...
            render={<Link route="admin.posts.destroy" routeParams={{ id: row.original.id }} />}
          >
            Delete
            <MenuShortcut>
              <TrashIcon size={16} />
