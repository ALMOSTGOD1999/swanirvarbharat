...
export default function SeriesTableFilters({
  querySearch,
  setQuerySearch,
  selectedStates,
  setSelectedStates,
  ...
  const buildParams = React.useCallback(
    ...
    [querySearch, selectedStates, selectedOwnerIds, selectedTaxonomyNames, dateFrom, dateTo, limit]
  )
